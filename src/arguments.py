...
def add_dataset_args(parser):
    parser.add_argument('--dataset_path', type=str, help='', default='wikitext')
    parser.add_argument('--dataset_name', type=str, help='', default='wikitext-2-raw-v1')
    parser.add_argument('--dataset_data_split_percentage', type=int, help='', default=15)
    ...
    parser.add_argument('--dataset_path_to_synthetic_data', type=str, help='', default='/home/aaa208/scratch/PANORAMIA/outputs/WikiText-2/generator/saved_synthetic_data/syn_data.csv')
    parser.add_argument('--dataset_synthetic_text_column_name', type=str, help='', default='text')
    parser.add_argument('--dataset_seed', type=int, help='', default=42)
    ...
    parser.add_argument('--dataset_generator_train_percent', type=int, help='', default=22)
...
def add_generator_args(parser):
    ...
    parser.add_argument('--generator_generation_parameters_num_return_sequences', type=int, help='', default=1)
...
def add_audit_args(parser):
    ...
    parser.add_argument('--audit_target_saving_dir', type=str, help='', default='/home/aaa208/scratch/PANORAMIA/outputs/WikiText-2/audit_model/target_with_Syn/saved_model/epoch_60/')
    ...
    parser.add_argument('--audit_target_optimization_epoch', type=int, help='', default=60)
    ...
    parser.add_argument('--audit_helper_saving_dir', type=str, help='', default='/home/aaa208/scratch/PANORAMIA/outputs/WikiText-2/audit_model/helper/saved_model/epoch_30/checkpoint-726/')
    ...
    parser.add_argument('--audit_helper_optimization_epoch', type=int, help='', default=15)
...
def add_attack_args(parser):
    ...
    parser.add_argument('--attack_mia_training_args_phase1_max_steps', type=int, help='', default=500)
    parser.add_argument('--attack_mia_training_args_phase1_batch_size', type=int, help='', default=32)
    parser.add_argument('--attack_mia_training_args_phase1_learning_rate', type=float, help='', default=0.03)
    ...
    parser.add_argument('--attack_baseline_training_args_phase1_max_steps', type=int, help='', default=250)
    parser.add_argument('--attack_baseline_training_args_phase1_batch_size', type=int, help='', default=32)
    parser.add_argument('--attack_baseline_training_args_phase1_learning_rate', type=float, help='', default=0.03)
