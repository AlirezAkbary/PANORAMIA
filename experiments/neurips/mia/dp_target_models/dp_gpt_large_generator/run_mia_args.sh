...
log_dir="/home/aaa208/scratch/PANORAMIA/experiments/neurips/mia/dp_target_models/dp_gpt_large_generator/epsilon_$epsilon/n_train_$attack_num_train/n_test_$attack_num_test/$which_helper/mia_seed_$mia_seed_num/train_seed_$training_seed_num/"
output_dir="/home/aaa208/scratch/PANORAMIA/outputs/neurips/attacks/mia/dp_target_models/dp_gpt_large_generator/epsilon_$epsilon/n_train_$attack_num_train/n_test_$attack_num_test/$which_helper/mia_seed_$mia_seed_num/train_seed_$training_seed_num/"

syn_data_dir="/home/aaa208/scratch/PANORAMIA/outputs/neurips/dp_gpt_large_generator/saved_dp_synthetic_data/syn_data.csv"
helper_dir="/home/aaa208/scratch/PANORAMIA/outputs/neurips/audit_model/helper_dp_gpt_large/saved_model/epoch_60/checkpoint-2280/"

audit_mode="RMFN_fixed_test"
                      
python -m src.main  --base_log_dir $log_dir \
                    --base_project_name "PANORAMIA-neurips-mia-dp_target_models-dp_gpt_large_generator-eps_$epsilon-$which_helper" \
                    ...
                    --generator_train_saving_dir "/home/aaa208/scratch/PANORAMIA/outputs/neurips/dp_gpt_large_generator/saved_model/epsilon_3/clip_norm_0.1/lr_0.001/gradient_accumulation_steps_256/num_epoch_20/" \
                    ...
                    --generator_generation_saving_dir "/home/aaa208/scratch/PANORAMIA/outputs/neurips/dp_gpt_large_generator/saved_dp_synthetic_data/" \
                    ...
                    --audit_target_saving_dir "/home/aaa208/scratch/PANORAMIA/outputs/neurips/audit_model/saved_model/dp_models/epsilon_$epsilon/clip_norm_0.1/lr_0.001/gradient_accumulation_steps_256/num_epoch_20/epoch_20/" \
