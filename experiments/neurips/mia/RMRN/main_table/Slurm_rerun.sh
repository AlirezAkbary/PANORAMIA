...
base_dir="/home/aaa208/scratch/PANORAMIA/outputs/neurips/attacks/mia/RMRN/main_table/"

filename="experiments/neurips/mia/RMRN/main_table/run_mia_args.sh"

# Define ranges for var1, var2, and var3
var1_range=("checkpoint-12000" "checkpoint-25000" "checkpoint-50000")
var2_range=(5000)  # Example range for var1
    ...
    for var2 in "${var2_range[@]}"; do
        for var3 in "${var3_range[@]}"; do
            for var4 in "${var4_range[@]}"; do
                ...
                directory="${var1}/n_train_4000/n_test_${var2}/mix/mia_seed_${var3}/train_seed_${var4}"
