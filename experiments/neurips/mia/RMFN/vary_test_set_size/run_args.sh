...
log_dir="/home/aaa208/scratch/PANORAMIA/experiments/neurips/mia/RMFN/vary_test_size/$target_checkpoint/n_test_$attack_num_test/$which_helper/mia_seed_$mia_seed_num/train_seed_$training_seed_num/"
output_dir="/home/aaa208/scratch/PANORAMIA/outputs/neurips/attacks/mia/RMFN/vary_test_size/$target_checkpoint/n_test_$attack_num_test/$which_helper/mia_seed_$mia_seed_num/train_seed_$training_seed_num/"

audit_mode="RMFN"
                      
python -m src.main  --base_log_dir $log_dir \
                    --base_project_name "PANORAMIA-neurips-mia-RMFN_vary_test_size-$target_checkpoint-$which_helper" \
                    ...
                    --attack_mia_run_name "RMFN_vary_test_set_size" \
