...
log_dir="/home/aaa208/scratch/PANORAMIA/experiments/neurips/mia/RMFN/$target_checkpoint/n_train_$attack_num_train/$which_helper/mia_seed_$mia_seed_num/train_seed_$training_seed_num/"
output_dir="/home/aaa208/scratch/PANORAMIA/outputs/neurips/attacks/mia/RMFN/$target_checkpoint/n_train_$attack_num_train/$which_helper/mia_seed_$mia_seed_num/train_seed_$training_seed_num/"

audit_mode="RMFN_fixed_test"
                      
python -m src.main  --base_log_dir $log_dir \
                    --base_project_name "PANORAMIA-neurips-mia-RMFN_fixed_test-$target_checkpoint-$which_helper" \
                    ...
                    --attack_mia_run_name "RMFN_fixed_test" \
