...
log_dir="/home/aaa208/scratch/PANORAMIA/experiments/neurips/mia/varying_complexities/dp_gpt_small_generator/$target_checkpoint/n_train_$attack_num_train/n_test_$attack_num_test/$which_helper/mia_seed_$mia_seed_num/train_seed_$training_seed_num/"
output_dir="/home/aaa208/scratch/PANORAMIA/outputs/neurips/attacks/mia/varying_complexities/dp_gpt_small_generator/$target_checkpoint/n_train_$attack_num_train/n_test_$attack_num_test/$which_helper/mia_seed_$mia_seed_num/train_seed_$training_seed_num/"
...
python -m src.main  --base_log_dir $log_dir \
                    --base_project_name "PANORAMIA-neurips-mia-varying_complexities_dp_gpt_small_generator-$target_checkpoint-$which_helper" \
