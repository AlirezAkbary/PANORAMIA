...
base_dir="/home/aaa208/scratch/PANORAMIA/outputs/neurips/attacks/mia/dp_synthetic/main_table/"

filename="experiments/neurips/mia/dp_synthetic/main_table/run_mia_args.sh"

# Define ranges for var1, var2, and var3
var1_range=("checkpoint-12000" "checkpoint-25000" "checkpoint-50000")
var2_range=(1000 5000 10000)  # Example range for var1
