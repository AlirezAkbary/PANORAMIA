...
base_dir="/home/aaa208/scratch/PANORAMIA/outputs/neurips/attacks/baseline/RMFN/vary_train_test_size/"

filename="experiments/neurips/baseline/RMFN/vary_train_test_size/run_args.sh"
