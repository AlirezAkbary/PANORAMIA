...
filename="experiments/neurips/baseline/gpt_large_generator/vary_train_test_size/run_args.sh"

for attack_main in "baseline"
do
    for attack_num_train in 1000 5000 10000 15000 20000 25000 30000 35000 38000
    do
