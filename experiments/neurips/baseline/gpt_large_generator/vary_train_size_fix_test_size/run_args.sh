...
log_dir="/home/aaa208/scratch/PANORAMIA/experiments/neurips/baseline/gpt_large_generator/vary_train_size_fix_test_size/n_train_$attack_num_train/$which_helper/mia_seed_$mia_seed_num/train_seed_$training_seed_num/"
output_dir="/home/aaa208/scratch/PANORAMIA/outputs/neurips/attacks/baseline/gpt_large_generator/vary_train_size_fix_test_size/n_train_$attack_num_train/$which_helper/mia_seed_$mia_seed_num/train_seed_$training_seed_num/"
...
python -m src.main  --base_log_dir $log_dir \
                    --base_project_name "PANORAMIA-arxiv-v2-baseline-RMFN_vary_train_size_fix_test_size-$which_helper-attempt_2" \
                    ...
                    --attack_baseline_run_name "RMFN_vary_train_size_fix_test_size" \
