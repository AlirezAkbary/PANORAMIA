...
log_dir="/home/aaa208/scratch/PANORAMIA/experiments/neurips/baseline/RMFN/vary_train_test_size/n_train_$attack_num_train/$which_helper/mia_seed_$mia_seed_num/train_seed_$training_seed_num/"
output_dir="/home/aaa208/scratch/PANORAMIA/outputs/neurips/attacks/baseline/RMFN/vary_train_test_size/n_train_$attack_num_train/$which_helper/mia_seed_$mia_seed_num/train_seed_$training_seed_num/"

audit_mode="RMFN_train_test_complement"

                                    
python -m src.main  --base_log_dir $log_dir \
                    --base_project_name "PANORAMIA-neurips-baseline-RMFN_vary_train_test-$which_helper" \
