...
base_dir="/home/aaa208/scratch/PANORAMIA/outputs/neurips/attacks/baseline/RMFN/"

filename="experiments/neurips/baseline/RMFN/run_args.sh"

# Define ranges for var1, var2, and var3
var1_range=(1000 5000 10000 15000 20000 25000)  # Example range for var1
    ...
    for var2 in "${var2_range[@]}"; do
        for var3 in "${var3_range[@]}"; do
            ...
            if [ ! -f "${base_dir}${directory}/test_preds.npy" ]; then
                ...
                sbatch --exclude=cdr2550,cdr2591 $filename "baseline" $var1 30 "mix" $var2 $var3
            fi
        done
    done
done
