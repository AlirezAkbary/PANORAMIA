...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/target_with_aux/mia_with_helper/RMFN/e25/" \
                    --base_project_name "Target_with_aux-PANORAMIA-Wiki-Text-2-mia_with_helper-RMFN-E25" \
                    ...
                    --audit_target_saving_dir "/home/aaa208/scratch/PANORAMIA/outputs/WikiText-2/audit_model/target_with_aux/target/checkpoints/epoch_100/checkpoint-4100/" \
                    --audit_target_seed 42 \
                    --audit_target_run_name "target_on_first_90_percent_aux_data_epoch_12_block_size_64" \
                    ...
                    --attack_mia_net_type "all" \
                    --attack_mia_distinguisher_type "GPT2Distinguisher" \
                    --attack_mia_run_name "RMFN" \
                    --attack_mia_training_args_seed $attack_seed_num \
                    --attack_mia_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/target_with_aux/mia_with_helper/RMFN/e25/" \
