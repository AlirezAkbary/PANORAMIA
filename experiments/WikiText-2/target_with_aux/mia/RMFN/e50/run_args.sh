...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/target_with_aux/mia/RMFN/e50/" \
                    --base_project_name "Target_with_aux-PANORAMIA-Wiki-Text-2-mia-RMFN-E50" \
                    ...
                    --audit_target_run_name "target_on_first_90_percent_aux_data_epoch_25_block_size_64" \
                    ...
                    --attack_mia_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/target_with_aux/mia/RMFN/e50/" \
