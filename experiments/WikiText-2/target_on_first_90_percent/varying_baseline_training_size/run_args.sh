...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/target_on_first_90_percent/varying_baseline_training_size/" \
                    --base_project_name "PANORAMIA-Wiki-Text-2-target_on_first_90_percent-varying_attack_train_num_helper_with_syn_block_size_64" \
