...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/target_on_first_90_percent/baseline/RMFN/" \
                    --base_project_name "PANORAMIA-Wiki-Text-2-target_on_first_90_percent-baseline-RMFN_helper_with_syn_block_size_64" \
                    ...
                    --attack_baseline_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/target_on_first_90_percent/baseline/RMFN/" \
