...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/target_on_first_90_percent/mia_with_helper/e50/" \
                    --base_project_name "PANORAMIA-Wiki-Text-2-Final-target_on_first_90_percent-mia_with_helper_E50" \
                    ...
                    --audit_target_saving_dir "/home/aaa208/scratch/PANORAMIA/outputs/WikiText-2/audit_model/target_on_first_90_percent/target/checkpoints/epoch_100/checkpoint-6600/" \
                    --audit_target_seed 42 \
                    --audit_target_run_name "target_on_first_90_percent_epoch_50_block_size_64" \
                    ...
                    --attack_mia_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/target_on_first_90_percent/mia_with_helper/RMFN/e50/" \
