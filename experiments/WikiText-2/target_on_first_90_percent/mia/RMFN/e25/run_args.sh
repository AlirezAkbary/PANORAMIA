...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/target_on_first_90_percent/mia/e25/" \
                    --base_project_name "PANORAMIA-Wiki-Text-2-Final-target_on_first_90_percent-mia_E25" \
                    ...
                    --attack_mia_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/target_on_first_90_percent/mia/RMFN/e25/" \
