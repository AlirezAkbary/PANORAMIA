...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/paper/target_whole/mia/RMFN/rebuttal_extra_test/$target_checkpoint/" \
                    --base_project_name "PANORAMIA-Wiki_Text_2-paper-target_whole-mia-RMFN-rebuttal_extra_test-$target_checkpoint" \
                    ...
                    --attack_mia_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/paper/target_whole/mia/RMFN/$target_checkpoint/" \
                    --attack_mia_training_args_which_test "test_$extra_m-k" \
