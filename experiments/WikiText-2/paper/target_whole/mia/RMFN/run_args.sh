...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/paper/target_whole/mia/RMFN/$target_checkpoint/" \
                    --base_project_name "PANORAMIA-Wiki_Text_2-paper-target_whole-mia-RMFN-$target_checkpoint" \
