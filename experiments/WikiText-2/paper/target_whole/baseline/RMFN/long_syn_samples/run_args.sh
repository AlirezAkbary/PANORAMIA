...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/paper/target_whole/baseline/RMFN/long_syn_samples/game_seed_$game_seed_num/" \
                    --base_project_name "PANORAMIA-Wiki_Text_2-paper-target_whole-baseline-RMFN-long_syn_samples" \
                    --base_attack_main $attack_main \
                    --dataset_path "wikitext" \
                    --dataset_name "wikitext-2-raw-v1" \
                    --dataset_path_to_synthetic_data "/home/aaa208/scratch/PANORAMIA/outputs/WikiText-2/generator/paper/target_whole/saved_long_synthetic_data/syn_data.csv" \
                    ...
                    --attack_baseline_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/paper/target_whole/baseline/long_syn_samples/RMFN/game_seed_$game_seed_num/" \
