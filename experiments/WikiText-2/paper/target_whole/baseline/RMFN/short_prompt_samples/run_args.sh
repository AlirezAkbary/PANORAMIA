...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/paper/target_whole/baseline/RMFN/short_prompt_samples/game_seed_$game_seed_num/" \
                    --base_project_name "PANORAMIA-Wiki_Text_2-paper-target_whole-baseline-RMFN-short_prompt_samples" \
                    ...
                    --attack_baseline_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/paper/target_whole/baseline/short_prompt_samples/RMFN/game_seed_$game_seed_num/" \
