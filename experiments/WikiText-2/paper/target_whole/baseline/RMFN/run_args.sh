...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/paper/target_whole/baseline/RMFN/game_seed_$game_seed_num/" \
                    --base_project_name "PANORAMIA-Wiki_Text_2-paper-target_whole-baseline-RMFN-smaller_lr" \
