...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/paper/target_with_canaries/mia/RMFMFN/model_selection_eps/$target_checkpoint/" \
                    --base_project_name "paper-target_canaries-mia-model_selection_eps-RMFMFN-$target_checkpoint" \
                    ...
                    --attack_mia_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/paper/target_with_canaries/mia/RMFMFN/model_selection_eps/$target_checkpoint/" \
