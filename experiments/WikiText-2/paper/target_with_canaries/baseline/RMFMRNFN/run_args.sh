...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/paper/target_with_canaries/baseline/RMFMRNFN/game_seed_$game_seed_num/$which_helper/" \
                    --base_project_name "PANORAMIA-Wiki_Text_2-paper-target_canaries-baseline-RMFMRNFN-$which_helper" \
                    ...
                    --attack_baseline_run_name "RMFMRNFN" \
                    --attack_baseline_training_args_seed $attack_seed_num \
                    --attack_baseline_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/paper/target_with_canaries/baseline/RMFMRNFN/game_seed_$game_seed_num/$which_helper/" \
