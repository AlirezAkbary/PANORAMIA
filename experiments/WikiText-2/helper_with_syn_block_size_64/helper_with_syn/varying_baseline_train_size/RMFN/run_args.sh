...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/helper_with_syn_block_size_64/varying_baseline_mia_num_train_updated/" \
                    --base_project_name "PANORAMIA-Wiki-Text-2-varying_attack_train_num_helper_with_syn_block_size_64_updated" \
                    ...
                    --attack_baseline_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/helper_with_syn/varying_attack_train_num/baseline/" \
