...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/helper_with_syn_block_size_64/" \
                --base_project_name "PANORAMIA-Wiki-Text-2-helper_with_syn_block_size_64" \
                ...
                --attack_mia_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/helper_with_syn/mia/" \
                --attack_mia_training_args_max_steps 500 \
                ...
                --attack_baseline_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/helper_with_syn/baseline/" \
                --attack_baseline_training_args_max_steps 500 \
