...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/shuffle_wt_2_test/baseline/RMRN/helper_with_syn/seed_$game_seed_num/" \
                    --base_project_name "PANORAMIA-Wiki-Text-2-shuffle_wt_2_test-helper_with_syn-RMRN_6000_block_size_64" \
                    --base_attack_main $attack_main \
                    --dataset_path "wikitext" \
                    --dataset_name "wikitext-2-raw-v1" \
                    --dataset_path_to_synthetic_data "/home/aaa208/scratch/PANORAMIA/outputs/WikiText-2/generator/shuffle_wt_2_test/saved_synthetic_data/syn_data.csv" \
                    --dataset_synthetic_text_column_name "text" \
                    --dataset_seed 8 \
                    --dataset_do_shuffle \
                    --dataset_pretrained_model_name_or_path "gpt2" \
                    --dataset_block_size 64 \
                    --dataset_generator_train_percent 39 \
                    --dataset_prompt_sampling_percent 21 \
                    --dataset_target_model_percent 80 \
                    ...
                    --audit_target_saving_dir "/home/aaa208/scratch/PANORAMIA/outputs/WikiText-2/audit_model/target_on_first_90_percent/e100/saved_model/epoch_100/" \
                    --audit_target_seed 42 \
                    --audit_target_run_name "target_on_first_90_percent_epoch_100_block_size_64" \
                    ...
                    --audit_helper_saving_dir "/home/aaa208/scratch/PANORAMIA/outputs/WikiText-2/audit_model/shuffle_wt_2_test/helper_with_syn/saved_model/epoch_40/checkpoint-1364/" \
                    ...
                    --attack_mia_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/target_on_first_90_percent/varying_attack_train_num/mia/target_e100/" \
                    --attack_mia_training_args_max_steps 2000 \
                    ...
                    --attack_mia_training_args_phase1_max_steps 1000 \
                    ...
                    --attack_baseline_run_name "RMRN" \
                    --attack_baseline_training_args_seed $attack_seed_num \
                    --attack_baseline_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/shuffle_wt_2_test/baseline/RMRN/helper_with_syn/seed_$game_seed_num/" \
