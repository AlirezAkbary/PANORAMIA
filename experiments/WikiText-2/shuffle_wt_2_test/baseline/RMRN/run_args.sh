...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/shuffle_wt_2_test/baseline/RMRN/check_6000/seed_$game_seed_num/" \
                    --base_project_name "PANORAMIA-Wiki-Text-2-shuffle_wt_2_test-baseline-not-zero-RMRN_6000_helper_with_syn_block_size_64" \
                    ...
                    --attack_baseline_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/shuffle_wt_2_test/baseline/RMRN/check_6000/seed_$game_seed_num/" \
