...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/final_target_on_first_45_percent/baseline/fixed_seed/RMFN/no_helper/" \
                    --base_project_name "PANORAMIA-Wiki-Text-2-final_target_on_first_45_percent-fixed_seed-baseline-no_helper-RMFN" \
                    ...
                    --attack_mia_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/helper_with_syn/varying_attack_train_num/mia/" \
                    ...
                    --attack_baseline_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/final_target_on_first_45_percent/baseline/fixed_seed/RMFN/no_helper/" \
                    --attack_baseline_training_args_max_steps 3000 \
