...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/final_target_on_first_45_percent/baseline/fixed_seed/RMFN/helper_with_syn/" \
                    --base_project_name "PANORAMIA-Wiki-Text-2-final_target_on_first_45_percent-fixed_seed-baseline-helper-with-syn-RMFN" \
                    ...
                    --attack_baseline_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/final_target_on_first_45_percent/baseline/fixed_seed/RMFN/helper_with_syn/" \
