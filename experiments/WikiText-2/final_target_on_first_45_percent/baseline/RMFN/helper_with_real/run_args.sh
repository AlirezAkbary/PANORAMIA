...
python -m src.main  --base_log_dir "/home/aaa208/scratch/PANORAMIA/experiments/WikiText-2/final_target_on_first_45_percent/baseline/helper_with_real/" \
                    --base_project_name "PANORAMIA-Wiki-Text-2-final_target_on_first_45_percent" \
                    ...
                    --attack_baseline_training_args_output_dir "/scratch/aaa208/PANORAMIA/outputs/WikiText-2/attacks/final_target_on_first_45_percent/baseline/RMFN/helper_with_real/" \
